    ...
    <head>
		...
		function changePw(){
			...
			if((pwlength < 6 || pwlength > 16) || (pwagainlength < 6 && pwagainlength > 16)){
                ...
                document.getElementById("subbut").hidden = true;
			}else{
				document.getElementById("notgoodlength").hidden = true;
                document.getElementById("subbut").hidden = false;
			}
...
?>
        ...
        <h1 style="color:white;font-size:50px;font-family:Segoe;">Sign in</h1>
            ...
            <p><input onchange="picturechange()" id="profile_picture" type="file" name="profile_picture" accept="image/*;capture=camera"></p>
            <button hidden="true" type="submit" id="subbut" class="buttonshadow">Sign In</button><br><br>
            </form>
        </div>
    <br><br>
