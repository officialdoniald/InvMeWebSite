...
<div align="center">
  ...
  <form onSubmit="return checkSubmit()" method="post" action="php_files/create_events.php">
    ...
    <textarea class="textarea" required name="description"></textarea><br><label>Event description</label><br><br>
    ...
    <input type="text" required id="address" name="event_town"><br><label>Event town</label><br><br>
    <input type="text" required name="event_place"><br><label>Event place</label><br><br>
    <div id="map2" style="width:300px;height:300px"></div>
    <label>Mark the party point on the map(required)</label><br><br>
    <input type="text" required name="where_meet"><br><label>Meet description(when and where)</label><br><br>
    <div id="map" style="width:300px;height:300px"></div>
    <label>Mark the meeting point on the map(required)</label><br><br>
    ...
    <p>
      <button class="buttonshadow" id="bu" type="submit">Create my event</button>
    </p>
<br>
